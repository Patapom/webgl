...
//// PATANOTE: To auhtorize local flash content
...
//debugger;
  ...
  this._initMovie = function() {
    ...
    if (typeof _s.oninitmovie == 'function') {
	  window.setTimeout(_s.oninitmovie,1);
    }
  };
  ...
  this.handleFocus = function() {
    ...
    window.setTimeout(_s.waitForExternalInterface,500);
    // detach event
  ...
  this.beginDelayedInit = function() {
    ...
    window.setTimeout(_s.waitForExternalInterface,500);
    window.setTimeout(_s.beginInit,20);
  };
