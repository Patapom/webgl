...
BRDFEigen.prototype =
{
	...
	, Init : function( opt_LoadedCallback )
	{
		...
		patapi.helpers.LoadTypedArray( "./Eigens/" + this.name + ".slice", function( _URL, _ArrayBuffer )
		{
...
patapi.helpers.Extend( BRDFEigen.prototype, BRDFBase.prototype );	// Inherit from BRDFBase
