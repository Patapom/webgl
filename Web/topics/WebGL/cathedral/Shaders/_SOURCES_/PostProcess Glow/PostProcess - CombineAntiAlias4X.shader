...
{
 	float4	Result0 = SampleInputTexture( image0, imageTexCoords0, _Input.UV + float2( 0.42 * imageTexCoords0.z, 0.07 * imageTexCoords0.w ) );
 			Result0 += SampleInputTexture( image0, imageTexCoords0, _Input.UV + float2( 0.92 * imageTexCoords0.z, 0.42 * imageTexCoords0.w ) );
 			Result0 += SampleInputTexture( image0, imageTexCoords0, _Input.UV + float2( 0.07 * imageTexCoords0.z, 0.57 * imageTexCoords0.w ) );
 			Result0 += SampleInputTexture( image0, imageTexCoords0, _Input.UV + float2( 0.57 * imageTexCoords0.z, 0.92 * imageTexCoords0.w ) );
			Result0 *= 0.25;
