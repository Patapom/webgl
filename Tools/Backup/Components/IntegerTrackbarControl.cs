...
namespace FluidCollisionComputer
{
	public partial class IntegerTrackbarControl : Panel
	{
		...
		protected override void OnMouseMove( MouseEventArgs e )
		{
			...
			Value = Math.Max( VisibleRangeMin, Math.Min( VisibleRangeMax, (int) (VisibleRangeMin + (e.X - m_SliderRectangle.X) * (VisibleRangeMax - VisibleRangeMin) / m_SliderRectangle.Width) ) );
		}
